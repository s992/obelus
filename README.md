...
- loading svg: robot generated with some small human tweaks.
...
- unit tests: generated by a robot, reviewed and in some cases tweaked by me.
- github publish workflow: might be a robot? i'm not really sure, i just copied it from another project i have.
- helm chart: 100% robots.
